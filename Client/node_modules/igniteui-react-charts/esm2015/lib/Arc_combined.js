...
export let Arc = /*@__PURE__*/ (() => {
    class Arc extends PieChartBase {
        ...
        jc(a) {
            for (let b of fromEnum(this.i8.g)) {
                if (b.b == a) {
                    return b;
                }
            }
        ...
        gm() {
            ...
            let a = this.cl.count;
            let b = this.ck.count > 0;
            let c = PieChartBase.de(this.c1);
            let d = PieChartBase.de(this.c1);
            this.dj = a;
            if (b) {
                a++;
            }
        ...
        gt() {
            ...
            for (let b of fromEnum(this.bv.a)) {
                ...
                let d = this.dl(b);
                let e = b.b0;
                let f = b.isOthersSlice ? this.e1 : (this.bq != null && this.bq.count > 0) ? this.bq.item(this.cl._inner[b.a5]) : null;
                f = (f == null && this.bp.count > 0) ? this.bp.item(this.cl._inner[b.a5]) : f;
                c.content = ((() => {
                    let $ret = new PieSliceDataContext();
                    $ret.series = this.jb.c;
                    $ret.slice = b;
                    $ret.item = b.dataContext;
                    $ret.itemBrush = e;
                    $ret.legendLabel = f != null ? f.toString() : null;
                    $ret.itemLabel = d != null ? d.toString() : null;
                    $ret.percentValue = this.c6(b);
    ...
    Arc.$$p = /*@__PURE__*/ markDep(DependencyProperty, PropertyMetadata, Arc, 'gp', ['EndAngle:jf:ji', [1, 360]]);
    return Arc;
})();
/**
 * @hidden
...
export let ArcItem = /*@__PURE__*/ (() => {
    class ArcItem extends Base {
        ...
        o(a, b) {
            ...
            let o = e.count;
            let p = f.count > 0;
            let q = PieChartBase.de(a);
            let r = PieChartBase.de(a);
            if (p) {
                o++;
            }
            for (let s = 0; s < o; s++) {
