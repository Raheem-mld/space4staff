...
export let CategorySeriesInteractionManager = /*@__PURE__*/ (() => {
    class CategorySeriesInteractionManager extends Base {
        b$c(a, b) {
            ...
            let d = a.bx.bu;
            let e = a.ar();
            let f = a.getEffectiveViewport1(a.bx);
            let g = a.o7(a.bx);
            let h = -1;
            if (e != null && !c.isEmpty && !d.isEmpty) {
                let i = new ScalerParams(0, c, d, e.cc, f);
                let j = e.eb(g.left, i);
                let k = e.eb(g.right, i);
        ...
        b$d(a, b) {
            let c = a.bx.bv;
            let d = a.bx.bu;
            let e = a.getEffectiveViewport1(a.bx);
            ...
            let h = a.o7(a.bx);
            let i = new ScalerParams(0, c, d, f.cc, e);
            let j = 0;
            if (f.cf) {
