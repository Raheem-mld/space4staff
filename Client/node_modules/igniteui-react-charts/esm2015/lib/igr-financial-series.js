...
export class IgrFinancialSeries extends IgrSeries {
    ...
    */
    get xAxis() {
        ...
        if (!this.i.pq.externalObject) {
            let e = IgrCategoryAxisBase._createFromInternal(this.i.pq);
            if (e) {
                e._implementation = this.i.pq;
            }
            this.i.pq.externalObject = e;
        }
        return this.i.pq.externalObject;
    }
    set xAxis(v) {
        if (v != null && this._stylingContainer && v._styling)
            v._styling(this._stylingContainer, this, this);
        v == null ? this.i.pq = null : this.i.pq = v.i;
    }
    /**
    ...
    */
    get yAxis() {
        ...
        if (!this.i.qc.externalObject) {
            let e = IgrNumericYAxis._createFromInternal(this.i.qc);
            if (e) {
    ...
    */
    ...
    set transitionInMode(v) {
        this.i.p1 = ensureEnum(CategoryTransitionInMode_$type, v);
    }
    /**
    ...
    */
    ...
    getSeriesCloseValue(world, useInterpolation, skipUnknowns) {
        let iv = this.i.ri(toPoint(world), useInterpolation, skipUnknowns);
        return (iv);
    }
    getSeriesOpenValue(world, useInterpolation, skipUnknowns) {
        let iv = this.i.rj(toPoint(world), useInterpolation, skipUnknowns);
        return (iv);
    }
    getSeriesVolumeValue(world, useInterpolation, skipUnknowns) {
        let iv = this.i.rk(toPoint(world), useInterpolation, skipUnknowns);
        return (iv);
    }
    ...
    getSeriesOpenValuePosition(world, useInterpolation, skipUnknowns) {
        let iv = this.i.sy(toPoint(world), useInterpolation, skipUnknowns);
        return fromPoint(iv);
    }
    getSeriesCloseValuePosition(world, useInterpolation, skipUnknowns) {
        let iv = this.i.sx(toPoint(world), useInterpolation, skipUnknowns);
        return fromPoint(iv);
    }
    getSeriesVolumeValuePosition(world, useInterpolation, skipUnknowns) {
        let iv = this.i.sz(toPoint(world), useInterpolation, skipUnknowns);
        return fromPoint(iv);
    }
    /**
...
//# sourceMappingURL=igr-financial-series.js.map
