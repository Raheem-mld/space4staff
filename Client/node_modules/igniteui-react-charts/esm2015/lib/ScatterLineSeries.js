...
export let ScatterLineSeries = /*@__PURE__*/ (() => {
    class ScatterLineSeries extends ScatterBase {
        constructor() {
            ...
            let a = (b, c, d) => {
                let e = this.ch.indexOf(b.a);
                if (e == -1 || e == 0) {
                    return b;
                }
                let f = this.ch.item(e - 1);
                let g;
        ...
        s3(a, b) {
            ...
            let h = new ScalerParams(0, c, d, this.rb.d, e);
            let i = ((() => {
                let $ret = new ScalerParams(0, c, d, this.rb.e, e);
                $ret.b = this.f2();
                return $ret;
            })());
            let j = arrayShallowClone(this.rr.asArray());
            let k = arrayShallowClone(this.rs.asArray());
        ...
        te(a, b) {
            ...
            this.ua(e.dg, a.m.count, (h) => a.m._inner[h].x, (h) => a.m._inner[h].y, this.t4, this.gh);
        }
        ua(a, b, c, d, e, f) {
        ...
        t9(a, b, c, d, e, f) {
            if (c > -1) {
                let g = this.gh;
                let h = this.t6(new List$1(Number_$type, 0), d, e, b, c, g);
                let i;
    ...
    ScatterLineSeries.$$p = /*@__PURE__*/ markDep(DependencyProperty, PropertyMetadata, ScatterLineSeries, 'raisePropertyChanged', ['UnknownValuePlotting:t4:ub', [UnknownValuePlotting_$type, /*@__PURE__*/ enumGetBox(UnknownValuePlotting_$type, 1)]]);
