...
export let RadialAxisLabelPanelView = /*@__PURE__*/ (() => {
    class RadialAxisLabelPanelView extends HorizontalAxisLabelPanelBaseView {
        ...
        a2(a) {
            let b = ViewportUtils.f(0.5, this.a.cx, this.a.cw);
            this.a.j = ((() => {
                let $ret = new RotateTransform();
                $ret.j = (this.a1.dm * 180) / Math.PI;
                $ret.k = this.a1.dq.x;
                $ret.l = (this.a1.dq.y * a.height) + b;
                return $ret;
            })());
        }
        al() {
