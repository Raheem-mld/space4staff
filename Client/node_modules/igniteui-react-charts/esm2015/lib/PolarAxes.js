...
export let PolarAxes = /*@__PURE__*/ (() => {
    class PolarAxes extends Base {
        ...
        e(a, b, c, d, e, f, g, h) {
            ...
            let n;
            let o;
            let p = Math.min(this.a.kv, this.a.ku);
            let q = Math.max(this.a.kv, this.a.ku);
            let r = Math.min(this.b.ku, this.b.kv);
            let s = Math.max(this.b.ku, this.b.kv);
            let t = this.a.kl;
            let u = this.a.cc;
            let v = this.b.kl;
            let w = this.b.cc;
