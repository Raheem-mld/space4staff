...
export let FunnelLegendTemplates = /*@__PURE__*/ (() => {
    class FunnelLegendTemplates extends Base {
        ...
        static b(a) {
            ...
            let f = new Rectangle();
            f.width = a.availableWidth - (e * 2) - 2;
            f.height = a.availableHeight - (e * 2);
            f.n = e + 1;
            f.o = e;
            f.ac = e;
    ...
    FunnelLegendTemplates.$t = /*@__PURE__*/ markType(FunnelLegendTemplates, 'FunnelLegendTemplates');
    return FunnelLegendTemplates;
})();
//# sourceMappingURL=FunnelLegendTemplates.js.map
