...
export class IgrScatterTriangulationSeries extends IgrSeries {
    ...
    */
    get xAxis() {
        ...
        if (!this.i.pi.externalObject) {
            let e = IgrNumericXAxis._createFromInternal(this.i.pi);
            if (e) {
    ...
    */
    get yAxis() {
        ...
        if (!this.i.pj.externalObject) {
            let e = IgrNumericYAxis._createFromInternal(this.i.pj);
            if (e) {
                e._implementation = this.i.pj;
            }
            this.i.pj.externalObject = e;
        }
