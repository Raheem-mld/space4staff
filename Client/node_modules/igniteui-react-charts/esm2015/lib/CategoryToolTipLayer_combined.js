...
export let CategoryToolTipLayer = /*@__PURE__*/ (() => {
    class CategoryToolTipLayer extends AnnotationLayer {
        ...
        qp(a, b) {
            ...
            if (g) {
                r = (c + d) / 2;
                q = this.pf.right;
                if (this.qn == 2 || this.qn == 1) {
                    q = this.pf.left;
                }
                if (r < 0 || r > this.pf.bottom) {
                    r = NaN;
                }
            }
            else {
    ...
    CategoryToolTipLayer.$$p = /*@__PURE__*/ markDep(DependencyProperty, PropertyMetadata, CategoryToolTipLayer, 'raisePropertyChanged', ['TargetAxis:qm:qw', [Axis.$, null], 'ToolTipPosition:qn:qx', [CategoryTooltipLayerPosition_$type, /*@__PURE__*/ enumGetBox(CategoryTooltipLayerPosition_$type, 0)], 'UseInterpolation:qq:qy', [0, false]]);
    ...
    class CategoryToolTipLayerView extends AnnotationLayerView {
        ...
        ca() {
            if (this.b5 == null) {
                ...
                this.b5.bs(this.e.gw);
                this.b5.ao = this.e.ca.cf.k;
                this._tooltips = this.e.gw.createElement("div");
                this.b8 = this.e.gw.createElement("div");
        ...
        a6(a, b) {
            ...
            if (this.b5 != null) {
                this.b5.ap = c;
                this.b5.bu(this.b5.n, this.b5.o);
            }
        }
        al(a) {
            super.al(a);
            ...
            this.e.a6.addPointerTooltipData(a, f, g, h, i);
        }
    }
