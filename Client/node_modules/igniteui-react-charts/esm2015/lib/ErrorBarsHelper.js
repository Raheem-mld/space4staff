...
export let ErrorBarsHelper = /*@__PURE__*/ (() => {
    class ErrorBarsHelper extends Base {
        ...
        k(a, b, c, d, e) {
            ...
            let j = new ScalerParams(0, f, g, c.cc, h);
            let k = c.d8(a, j);
            let l = b.getIndependentValue();
            d = Math.abs(Math.round(c.d8(a + l, j) - k));
            e = Math.abs(Math.round(c.d8(a - l, j) - k));
            return {
                p3: d,
                p4: e
            };
        ...
        j(a, b, c, d, e) {
            ...
            g = h.p0;
            f = h.p1;
            let i = new ScalerParams(1, f, g, c.cc);
            let j = c.eb(a, i);
            let k = b.getIndependentValue();
            d = Math.abs(Math.round(c.d8(j + k, i) - a));
            e = Math.abs(Math.round(c.d8(j - k, i) - a));
            return {
                p3: d,
                p4: e
            };
        ...
        f(a, b, c, d, e, f) {
            ...
            h = i.p0;
            g = i.p1;
            let j = new ScalerParams(1, g, h, c.cc);
            let k = new ScalerParams(1, g, h, d.cc);
            let l = c.eb(a, j);
            let m = b.getDependentValue(l);
            e = Math.abs(Math.round(c.d8(l + m, k) - a));
            f = Math.abs(Math.round(c.d8(l - m, k) - a));
            return {
                p4: e,
                p5: f
            };
        ...
        h(a, b, c, d, e) {
            ...
            let i = new ScalerParams(1, f, g, c.cc);
            let j = c.eb(a, i);
            d = Math.abs(Math.round(c.d8(j + b, i) - a));
            e = Math.abs(Math.round(c.d8(j - b, i) - a));
            return {
                p3: d,
                p4: e
            };
        ...
        l(a, b, c, d) {
            ...
            if (a.getCalculatorType() == 3) {
                ...
                f = i.p1;
                h = this.a.getEffectiveViewport();
                let j = new ScalerParams(0, f, g, b.cc, h);
                e.x = Math.round(b.d8(d, j));
                e.y = Math.round(c.y);
            }
            else {
                e.x = Math.round(c.x);
