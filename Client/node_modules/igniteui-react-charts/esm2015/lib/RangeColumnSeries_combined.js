...
export let RangeColumnSeries = /*@__PURE__*/ (() => {
    class RangeColumnSeries extends HorizontalRangeCategorySeries {
        ...
        sl(a, b) {
            ...
            let m = this.xAxis;
            let n = new ScalerParams(0, e, f, this.xAxis.cc, g);
            let o = 0;
    ...
    RangeColumnSeries.$$p = /*@__PURE__*/ markDep(DependencyProperty, PropertyMetadata, RangeColumnSeries, 'raisePropertyChanged', ['RadiusX:th:tl', [1, 0], 'RadiusY:ti:tm', [1, 0]]);
