        ...
        v(a, b, c) {
            ...
            switch (a) {
                case SeriesViewerSurfaceViewer.$$p[0]:
                    ...
                    let d = this.l != null && this.l.b8 != null && this.l.b8.updatingSliderRanges;
                    if (!this.o && !d) {
                        let e = 1 - this.zoomLevel;
                        let f = RectUtil.l(this.l.pg);
                        let g = new Rect(0, f.x - e / 2, f.y - e / 2, e, e);
                        this.l.pw = SeriesViewerSurfaceViewer.z(this.l.pw, g, this.l.d4(), this.l.d5(), this.worldRect);
                    }
                    this.w();
                    if (this.l.b8 != null) {
                        this.l.b8.pushZoomLevel(this.zoomLevel);
                    }
                    break;
            }
        }
