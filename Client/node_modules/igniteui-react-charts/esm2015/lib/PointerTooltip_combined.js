        ...
        bm() {
            if (!this.as) {
                if (this.ao != null && this.am.l != null) {
                    this.as = true;
                    this.ao.aq(this.am.l, "pointerTooltip" + Base.getHashCodeStatic(this));
                }
            }
        }
        bv() {
            if (this.as) {
                if (this.ao != null && this.am.l != null) {
                    this.as = false;
                    this.ao.bc(this.am.l, "pointerTooltip" + Base.getHashCodeStatic(this));
                }
                this.ao = null;
            }
        }
