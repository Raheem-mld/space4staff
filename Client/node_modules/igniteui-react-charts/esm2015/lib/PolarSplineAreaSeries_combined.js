...
export let PolarSplineAreaSeries = /*@__PURE__*/ (() => {
    class PolarSplineAreaSeries extends PolarLineSeriesBase {
        ...
        uh(a, b) {
            ...
            let c = b;
            c.c6(a.m, this.uj);
            this.rk.ax(this, this.r7(), runOn(this, this.qx));
            let d = false;
            let e = this.rk.b;
            if (e != null) {
                d = true;
            ...
            if (d) {
                this.s7(-1, this.rt.count, b.q);
            }
            let f = c.dc;
            let g = c.db;
            this.rk.ad(f, true, false, true, true);
            this.rk.ad(g, false, true, false, false);
            g._opacity = this.rk.j * this.fi;
        }
        get_ud() {
            return true;
        }
    ...
    PolarSplineAreaSeries.$$p = /*@__PURE__*/ markDep(DependencyProperty, PropertyMetadata, PolarSplineAreaSeries, 'raisePropertyChanged', ['Stiffness:uj:ul', [1, 0.5]]);
...
export let PolarSplineAreaSeriesView = /*@__PURE__*/ (() => {
    class PolarSplineAreaSeriesView extends PolarLineSeriesBaseView {
        ...
        c5() {
            Extensions.e(this.c9.ak);
            Extensions.e(this.da.ak);
            Extensions.e(this.c7.ak);
            Extensions.e(this.c8.ak);
            this.aq();
        }
        c6(a, b) {
            this.da.ak.c = Numeric.h(a.count + 1, (c) => c < a.count ? a._inner[c].x : a._inner[c - a.count].x, (c) => c < a.count ? a._inner[c].y : a._inner[c - a.count].y, b);
            this.c9.ak.c = Numeric.h(a.count + 1, (c) => c < a.count ? a._inner[c].x : a._inner[c - a.count].x, (c) => c < a.count ? a._inner[c].y : a._inner[c - a.count].y, b);
            this.aq();
        }
        bb() {
            super.bb();
        ...
        al(a) {
            super.al(a);
            this.e.a6.exportPathData(a, this.da, "polarShape", ["Main"]);
            this.e.a6.exportPathData(a, this.c9, "fillShape", ["Fill"]);
        }
        af() {
            let a = new Color();
