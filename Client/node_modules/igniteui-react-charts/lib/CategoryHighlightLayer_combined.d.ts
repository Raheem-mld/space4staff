...
export declare class CategoryHighlightLayer extends AnnotationLayer {
    ...
    protected qn: CategoryHighlightLayerView;
    qm: CategoryAxisBase;
    qp: boolean;
    get qq(): number;
    set qq(a: number);
    static readonly qx: DependencyProperty;
    protected p2(a: Axis, b: boolean): void;
    private qo;
    protected p5(a: Frame, b: SeriesView): void;
    private qv;
    qu(a: Rect, b: CategoryHighlightLayerFrame, c: Axis): void;
    protected p8(a: Frame, b: SeriesView): void;
    protected eg(): boolean;
    qw(a: CategoryHighlightFrameRect, b: Rectangle): void;
