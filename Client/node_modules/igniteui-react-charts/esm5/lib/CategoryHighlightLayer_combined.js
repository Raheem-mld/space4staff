...
var CategoryHighlightLayer = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    CategoryHighlightLayer.prototype.get_c5 = function () {
        return true;
    };
    CategoryHighlightLayer.prototype.bu = function () {
        return new CategoryHighlightLayerView(this);
    };
    CategoryHighlightLayer.prototype.lh = function (a) {
        _super.prototype.lh.call(this, a);
        this.qn = a;
    };
    Object.defineProperty(CategoryHighlightLayer.prototype, "qq", {
        get: function () {
            return this.c(CategoryHighlightLayer.qx);
        },
        set: function (a) {
            this.h(CategoryHighlightLayer.qx, a);
        },
        enumerable: false,
        configurable: true
    });
    CategoryHighlightLayer.prototype.p2 = function (a, b) {
        if (this.qm == null || this.qm == a) {
            if (!this.as.c) {
                this.l0(b);
            }
        }
    };
    CategoryHighlightLayer.prototype.qo = function (a) {
        return a != null && a.ci();
    };
    CategoryHighlightLayer.prototype.p5 = function (a, b) {
        var e_1, _a;
        ...
        if (this.qm != null) {
            ...
            if (typeCast(XamDataChart.$, this.ca) !== null) {
                var e = this.ca;
                try {
                    for (var _b = __values(fromEnum(e.axes)), _c = _b.next(); !_c.done; _c = _b.next()) {
                        var f = _c.value;
                        if (typeCast(CategoryAxisBase.$, f) !== null && this.qo(f)) {
                            this.qv(f, c, d);
                        }
                    }
                }
    ...
    CategoryHighlightLayer.prototype.qv = function (a, b, c) {
        ...
        d = this.bx.bu.left + this.bx.bu.width * (d - this.bx.bv.left) / this.bx.bv.width;
        var e = this.qj.y;
        if (!a.cj && isNaN_(e)) {
            e = 0;
        }
        e = this.bx.bu.top + this.bx.bu.height * (e - this.bx.bv.top) / this.bx.bv.height;
        var f = a.ll({ $type: Point_$type, x: d, y: e }, c, this.qq);
        this.qu(f, b, a);
    };
    CategoryHighlightLayer.prototype.qu = function (a, b, c) {
    ...
    CategoryHighlightLayer.prototype.p8 = function (a, b) {
        var e_2, _a;
    ...
    CategoryHighlightLayer.prototype.eg = function () {
        return true;
    };
    CategoryHighlightLayer.prototype.qw = function (a, b) {
        if (isNaN_(a.b) || isNaN_(a.e) || isNaN_(a.a) || isNaN_(a.c) || isNaN_(a.d)) {
            b._visibility = 1;
            return;
        }
        this.qn.b7(b, a.b, a.e, a.c - a.b, a.a - a.e);
        b._fill = a.g;
        b._stroke = a.h;
        b.ac = a.d;
        if (this.os != null) {
    ...
    CategoryHighlightLayer.prototype.lm = function (a, b, c, d) {
    ...
    CategoryHighlightLayer.qx = DependencyProperty.i("BAndHighlightWidth", Number_$type, CategoryHighlightLayer.$, new PropertyMetadata(2, 10, function (a, b) { return a.raisePropertyChanged("BAndHighlightWidth", b.oldValue, b.newValue); }));
    CategoryHighlightLayer.$$p = markDep(DependencyProperty, PropertyMetadata, CategoryHighlightLayer, 'raisePropertyChanged', ['TargetAxis:qm:qy', [CategoryAxisBase.$, null], 'UseInterpolation:qp:qz', [0, false]]);
...
var CategoryHighlightLayerView = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    function CategoryHighlightLayerView(a) {
        ...
        _this.b6 = null;
        _this.b4 = a;
        _this.b6 = new List$1(Rectangle.$, 0);
        return _this;
    }
    CategoryHighlightLayerView.prototype.as = function () {
        var _this = this;
        _super.prototype.as.call(this);
        this.b5 = ((function () {
            var $ret = new Pool$1(Rectangle.$);
            $ret.create = runOn(_this, _this.cd);
            $ret.activate = runOn(_this, _this.b8);
            $ret.disactivate = runOn(_this, _this.ca);
            $ret.destroy = runOn(_this, _this.b9);
            return $ret;
        })());
    };
    CategoryHighlightLayerView.prototype.cd = function () {
        var a = new Rectangle();
        a.ab = false;
        this.b6.add(a);
        return a;
    ...
    CategoryHighlightLayerView.prototype.ca = function (a) {
        a._visibility = 1;
    };
    ...
    CategoryHighlightLayerView.prototype.b7 = function (a, b, c, d, e) {
        a._visibility = 0;
        a.n = b;
        a.o = c;
        a.width = d;
    ...
    CategoryHighlightLayerView.prototype.a6 = function (a, b) {
    ...
    CategoryHighlightLayerView.prototype.al = function (a) {
        _super.prototype.al.call(this, a);
        for (var b = 0; b < this.b6.count; b++) {
            this.e.a6.exportRectangleData(a, this.b6._inner[b], "cihRect", ["Main", "CategoryItem"]);
        }
    };
