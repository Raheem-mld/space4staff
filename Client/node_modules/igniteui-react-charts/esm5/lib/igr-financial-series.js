        ...
        */
        get: function () {
            ...
            if (!this.i.pq.externalObject) {
                var e = IgrCategoryAxisBase._createFromInternal(this.i.pq);
                if (e) {
        ...
        */
        get: function () {
            ...
            if (!this.i.qc.externalObject) {
                var e = IgrNumericYAxis._createFromInternal(this.i.qc);
                if (e) {
