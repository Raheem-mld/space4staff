...
var PolarAxes = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    PolarAxes.prototype.e = function (a, b, c, d, e, f, g, h) {
        ...
        var n;
        var o;
        var p = Math.min(this.a.kv, this.a.ku);
        var q = Math.max(this.a.kv, this.a.ku);
        var r = Math.min(this.b.ku, this.b.kv);
        var s = Math.max(this.b.ku, this.b.kv);
        var t = this.a.kl;
        var u = this.a.cc;
        var v = this.b.kl;
        var w = this.b.cc;
