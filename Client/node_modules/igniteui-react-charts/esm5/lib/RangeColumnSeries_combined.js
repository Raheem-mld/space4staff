...
var RangeColumnSeries = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    RangeColumnSeries.prototype.get_db = function () {
        return true;
    };
    RangeColumnSeries.prototype.get_dw = function () {
        return true;
    };
    RangeColumnSeries.prototype.bu = function () {
        return new RangeColumnSeriesView(this);
    };
    RangeColumnSeries.prototype.lh = function (a) {
        _super.prototype.lh.call(this, a);
        this.tg = a;
    };
    RangeColumnSeries.prototype.get_cy = function () {
        return true;
    };
    RangeColumnSeries.prototype.preferredCategoryMode = function (a) {
        return 2;
    };
    RangeColumnSeries.prototype.pb = function (a) {
    ...
    RangeColumnSeries.prototype.ep = function (a, b) {
        if (this.es(a, b)) {
            return true;
        }
        if (this.pu(a, b)) {
    ...
    RangeColumnSeries.prototype.kh = function (a, b) {
    ...
    RangeColumnSeries.prototype.f1 = function () {
        return this.xAxis.ki(this.bx.bv, this.bx.bu, this.getEffectiveViewport1(this.bx));
    };
    RangeColumnSeries.prototype.sl = function (a, b) {
        ...
        var m = this.xAxis;
        var n = new ScalerParams(0, e, f, this.xAxis.cc, g);
        var o = 0;
        for (var p = 0; p < d.count; ++p) {
            ...
            u.height = t;
            if (i) {
                this.sh(d, p, l, m, n, b.q);
            }
            this.rb.ad(u, false, false, false, false);
            u.am = this.rb.k;
            u.an = this.rb.l;
            c.c8(u, q, r);
        }
    ...
    RangeColumnSeries.$$p = markDep(DependencyProperty, PropertyMetadata, RangeColumnSeries, 'raisePropertyChanged', ['RadiusX:th:tl', [1, 0], 'RadiusY:ti:tm', [1, 0]]);
...
var RangeColumnSeriesView = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    RangeColumnSeriesView.prototype.as = function () {
        ...
        if (!this.q) {
            this.c2.pr = Defaults.c;
            this.c2.gh = Defaults.h;
            this.c2.gm = Defaults.i;
        }
    };
