...
var WaterfallSeries = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    WaterfallSeries.prototype.get_dw = function () {
        return true;
    };
    WaterfallSeries.prototype.get_dm = function () {
        return true;
    };
    WaterfallSeries.prototype.bu = function () {
        return new WaterfallSeriesView(this);
    };
    WaterfallSeries.prototype.lh = function (a) {
    ...
    WaterfallSeries.prototype.get_dx = function () {
        return true;
    };
    WaterfallSeries.prototype.l5 = function (a, b) {
        _super.prototype.l5.call(this, a, b);
        this.uq = a;
        this.ur = b;
    };
    WaterfallSeries.prototype.op = function () {
        return this.uq;
    };
    WaterfallSeries.prototype.oq = function () {
        return this.ur;
    };
    WaterfallSeries.prototype.b0 = function () {
        if (this.b1 == 0) {
            return 2;
        }
        return _super.prototype.b0.call(this);
    };
    WaterfallSeries.prototype.get_cy = function () {
        return true;
    };
    WaterfallSeries.prototype.lm = function (a, b, c, d) {
    ...
    WaterfallSeries.prototype.ep = function (a, b) {
        if (this.es(a, b)) {
            return true;
        }
        if (this.pu(a, b)) {
    ...
    WaterfallSeries.prototype.pb = function (a) {
        var _this = this;
        if (this.uf == null || this.uf.db == null || this.uf.db.count == 0 || this.xAxis == null) {
            return Rect.empty;
        }
        var b = this.uf.db;
        var c = this.ox(a);
    ...
    WaterfallSeries.prototype.us = function (a) {
        return this.uf.dh(a);
    };
    WaterfallSeries.prototype.rd = function () {
        return 1;
    };
    WaterfallSeries.prototype.kh = function (a, b) {
        _super.prototype.kh.call(this, a, b);
        this.uf.db.count = 0;
    };
    WaterfallSeries.prototype.get_s6 = function () {
        return 1;
    };
    WaterfallSeries.prototype.f1 = function () {
        return this.tw.ki(this.bx.bv, this.bx.bu, this.getEffectiveViewport1(this.bx));
    };
    WaterfallSeries.prototype.sl = function (a, b) {
        var c = b;
        _super.prototype.sl.call(this, a, b);
        var d = b.bv;
        var e = b.bu;
        var f = this.getEffectiveViewport1(b);
        var g = this.tw.ki(d, e, f);
        var h = this.ug;
        var i = this.uh;
        var j;
        var k = this.s4(b);
        ...
        var t = a.f;
        var u = this.tw;
        var v = new ScalerParams(0, d, e, this.tw.cc, f);
        var w = this.of;
        var x = this.uq;
        var y = this.oi;
        var z = this.ur || y;
        if (a.f.count > 0) {
            ...
            if (!isNaN_(aa)) {
                if (aa > k) {
                    ...
                    this.rb.f = true;
                    if (p) {
                        this.sh(t, 0, s, u, v, b.q);
                    }
                    this.rb.ad(n, false, false, false, false);
                    n.am = this.rb.k;
                    n.an = this.rb.l;
                }
                else {
    ...
    WaterfallSeries.$$p = markDep(DependencyProperty, PropertyMetadata, WaterfallSeries, 'raisePropertyChanged', ['NegativeBrush:uq:um', [Brush.$, null], 'NegativeOutline:ur:un', [Brush.$, null], 'RadiusX:ug:uo', [1, 0], 'RadiusY:uh:up', [1, 0]]);
...
var WaterfallSeriesView = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    WaterfallSeriesView.prototype.as = function () {
        ...
        if (!this.q) {
            ...
            this.da.uq = Defaults.ah;
            this.da.ur = Defaults.ai;
        }
    };
    WaterfallSeriesView.prototype.dk = function () {
        var a = new Rectangle();
        this.dc.add(a);
        a._visibility = 1;
        return a;
    ...
    WaterfallSeriesView.prototype.df = function (a) {
        a._visibility = 1;
    };
    WaterfallSeriesView.prototype.de = function (a) {
        this.dc.remove(a);
    };
    WaterfallSeriesView.prototype.dg = function (a, b, c) {
        var d = false;
        if (a.o != c) {
            d = true;
            a.o = c;
    ...
    WaterfallSeriesView.prototype.a6 = function (a, b) {
    ...
    WaterfallSeriesView.prototype.al = function (a) {
        var e_1, _a, e_2, _b;
        ...
        try {
            for (var _e = __values(fromEnum(c)), _f = _e.next(); !_f.done; _f = _e.next()) {
                var e = _f.value;
                var f = "Negative";
                if (e._fill == this.e.of) {
                    f = "Positive";
                }
                this.e.a6.exportRectangleData(a, e, "column" + b, ["Main", f]);
            }
        }
        catch (e_2_1) {
            e_2 = { error: e_2_1 };
    ...
    WaterfallSeriesView.prototype.dh = function (a) {
