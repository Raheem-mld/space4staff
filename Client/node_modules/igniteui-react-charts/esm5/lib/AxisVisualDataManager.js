...
var AxisVisualDataManager = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    AxisVisualDataManager.prototype.exportVisualData = function (a) {
        ...
        b.viewport = RectData.b(a.js);
        b.labelsViewport = RectData.b(a.a4.a6());
        b.type = this.c(getInstanceType(a).typeName);
        b.name = a.name;
        var c = new PathVisualData(1, "axisLine", a.a4.a7);
        b.axisLine = c;
        b.tickMarks = new PathVisualData(1, "tickMarks", a.av.ae.av);
        if (!a.av.ab.contains(a.av.ae.av)) {
            b.tickMarks.data.clear();
        }
        b.minorLines = new PathVisualData(1, "minorLines", a.a4.a9);
        b.majorLines = new PathVisualData(1, "majorLines", a.a4.a8);
        b.strips = new PathVisualData(1, "strips", a.a4.ba);
        if (a.gp != null) {
            var d = this.a(a, a.bh, b.type, a.h6);
            b.title = d;
        }
        else {
            b.title = null;
        ...
        if (a.ay != null && a.ay.textStyle != null) {
            e = a.ay.g(a.bh.cf.j.ae);
        }
        var f, g, h, i;
        var j = a.av.ae.av.ak.d;
        if (1 < j.count) {
        ...
        if (n.count > 0) {
            var _loop_1 = function (p) {
                var e_1, _a;
                var q = a.av.a6._inner[p];
                var r = a.av.a5._inner[p];
                var s = ((function () {
                    var $ret = new AxisLabelVisualData();
                    $ret.labelPosition = q.c;
                    $ret.labelValue = r;
                    $ret.panelPosition = PointData.b(a.a4.a3());
                    return $ret;
                })());
                ...
                if (p < t.count) {
                    ...
                    s.position = PointData.b(a.a4.a2(t._inner[p]));
    ...
    AxisVisualDataManager.prototype.b = function (a, b, c) {
        return FontUtil.getFontInfo(a.bh.cf.j.ae, b, c);
    };
