...
var Arc = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    Arc.prototype.gj = function (a) {
        _super.prototype.gj.call(this, a);
        this.i9 = a;
    };
    Object.defineProperty(Arc.prototype, "jb", {
        get: function () {
            return this.ja;
        },
        set: function (a) {
    ...
    Arc.prototype.gf = function (a, b) {
        _super.prototype.gf.call(this, a, b);
        if (this.jb != null) {
            this.jb.c.ax.bu(a, b);
        }
    };
    Arc.prototype.fu = function (a, b) {
        if (this.jb != null && this.jb.d != null) {
            _super.prototype.fu.call(this, a, b);
            var c = this.jc(a);
            if (c != null) {
                this.jb.d.bj(c, b);
            }
    ...
    Arc.prototype.gx = function (a, b) {
        if (this.jb != null && this.jb.d != null) {
            _super.prototype.gx.call(this, a, b);
            var c = this.jc(a);
            if (c != null) {
                this.jb.d.b5(c, b);
            }
    ...
    Arc.prototype.jc = function (a) {
        var e_1, _a;
        try {
            for (var _b = __values(fromEnum(this.i8.g)), _c = _b.next(); !_c.done; _c = _b.next()) {
                var b = _c.value;
                if (b.b == a) {
                    return b;
                }
    ...
    Arc.prototype.gm = function () {
        ...
        for (var e = 0; e < a; e++) {
            ...
            if (this.iw == 1) {
                d += PieChartBase.de(Math.abs(g) * this.jf / this.dg);
            }
            else {
                d -= PieChartBase.de(Math.abs(g) * this.jf / this.dg);
            }
    ...
    Arc.prototype.gt = function () {
        ...
        if (this.bp == null || this.bp.count == 0 || ((this.jb != null && this.jb.c != null) && (this.jb.d != null && !this.jb.d.series.contains(this.jb.c)))) {
            a.clearLegendItemsForSeries(this.jb.c);
            return;
        }
        ...
        var _loop_1 = function (b) {
            ...
            var d = this_1.dl(b);
            var e = b.b0;
            var f = b.isOthersSlice ? this_1.e1 : (this_1.bq != null && this_1.bq.count > 0) ? this_1.bq.item(this_1.cl._inner[b.a5]) : null;
            f = (f == null && this_1.bp.count > 0) ? this_1.bp.item(this_1.cl._inner[b.a5]) : f;
            c.content = ((function () {
                var $ret = new PieSliceDataContext();
                $ret.series = _this.jb.c;
                $ret.slice = b;
                $ret.item = b.dataContext;
                $ret.itemBrush = e;
                $ret.legendLabel = f != null ? f.toString() : null;
                $ret.itemLabel = d != null ? d.toString() : null;
                $ret.percentValue = _this.c6(b);
        ...
        if (a.isItemwise) {
            var k = a;
            k.createLegendItemsInsert(this.ci, this.jb.c);
        }
    };
    Arc.prototype.gn = function (a, b, c, d) {
        _super.prototype.gn.call(this, a, b, c, d);
        switch (b) {
            case Arc.$$p[0]:
                this.jd = d;
                this.gm();
            ...
            case "Legend":
                ...
                if (e != null && this.jb != null && this.jb.c != null) {
                    e.clearLegendItemsForSeries(this.jb.c);
                }
                break;
        }
    };
    Arc.prototype.jg = function () {
        return this.a3.ac();
    };
    Arc.$t = markType(Arc, 'Arc', PieChartBase.$);
    Arc.$$p = markDep(DependencyProperty, PropertyMetadata, Arc, 'gp', ['EndAngle:jf:ji', [1, 360]]);
    return Arc;
}(PieChartBase));
export { Arc };
/**
...
var ArcItem = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    ArcItem.prototype.o = function (a, b) {
        ...
        var o = e.count;
        var p = f.count > 0;
        var q = PieChartBase.de(a);
        var r = PieChartBase.de(a);
        if (p) {
            o++;
        }
        var _loop_2 = function (s) {
            ...
            var v = 1;
            if (v == 1) {
                r += PieChartBase.de(Math.abs(u) * b / c);
            }
            else {
                r -= PieChartBase.de(Math.abs(u) * b / c);
            }
    ...
    RingControl.prototype.an = function () {
        ...
        try {
            for (var _b = __values(fromEnum(this.ao)), _c = _b.next(); !_c.done; _c = _b.next()) {
                ...
                if ((d.width != this.ai.q.width || d.height != this.ai.q.height) && d.a3.r()) {
            ...
            switch (_d.label) {
                ...
                case 1:
                    if (!!_b.done)
                        return [3 /*break*/, 4];
                    b = _b.value;
                    if (!PieChartBase.ch(a, b.itemsSource))
                        return [3 /*break*/, 3];
                    return [4 /*yield*/, b];
                case 2:
                    _d.sent();
...
var RingControlView = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    RingControlView.prototype.ab = function (a) {
        this.k(a, a.jg().rootWrapper);
        a.f6(a.width, a.height);
    };
        ...
        switch (b.propertyName) {
            case "LabelExtent":
                for (var c = 0; c < this.f.count; c++) {
                    this.f._inner[c].c8 = b.newValue;
                }
                break;
            case "LabelMemberPath":
                for (var d = 0; d < this.f.count; d++) {
                    this.f._inner[d].ef = b.newValue;
                }
                break;
            case "LabelsPosition":
            ...
            case "LabelTemplate":
                for (var f = 0; f < this.f.count; f++) {
                    this.f._inner[f].g7 = b.newValue;
                }
                break;
            case "ValueMemberPath":
                for (var g = 0; g < this.f.count; g++) {
                    this.f._inner[g].fq = b.newValue;
                }
                break;
            case "ToolTip":
                for (var h = 0; h < this.f.count; h++) {
                    this.f._inner[h].dn = b.newValue;
                }
                break;
            case "LeaderLineVisibility":
                for (var i = 0; i < this.f.count; i++) {
                    this.f._inner[i].i7 = EnumUtil.getEnumValue(Visibility_$type, b.newValue);
                }
                break;
            case "LeaderLineStyle":
                for (var j = 0; j < this.f.count; j++) {
                    this.f._inner[j].i3 = b.newValue;
                }
                break;
            case "LeaderLineType":
            ...
            case "LeaderLineMargin":
                for (var l = 0; l < this.f.count; l++) {
                    this.f._inner[l].c9 = b.newValue;
                }
                break;
            case "OthersCategoryThreshold":
                for (var m = 0; m < this.f.count; m++) {
                    this.f._inner[m].da = b.newValue;
                }
                break;
            ...
            case "OthersCategoryText":
                for (var o = 0; o < this.f.count; o++) {
                    this.f._inner[o].e1 = b.newValue;
                }
                break;
            case "OthersCategoryStyle":
                for (var p = 0; p < this.f.count; p++) {
                    this.f._inner[p].i4 = b.newValue;
                }
                break;
            case "Legend":
            ...
            case "SelectedStyle":
                for (var v = 0; v < this.f.count; v++) {
                    this.f._inner[v].i5 = b.newValue;
                }
                break;
            case "SelectedStyleResolved":
                for (var w = 0; w < this.f.count; w++) {
                    this.f._inner[w].i5 = b.newValue;
                }
                break;
            case "RadiusFactor":
                for (var x = 0; x < this.f.count; x++) {
                    this.f._inner[x].dd = b.newValue;
                }
                break;
        }
    };
...
var XamDoughnutChartView = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    XamDoughnutChartView.prototype.r = function () {
        if (this.b != null) {
            this.b.bc(this.e.rootWrapper, "");
        }
    };
    XamDoughnutChartView.prototype.q = function () {
        this.p();
        if (this.b != null) {
            this.b.aq(this.e.rootWrapper, "");
        }
    };
