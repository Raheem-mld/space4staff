    ...
    Object.defineProperty(IgrScatterPolylineSeries.prototype, "shapeStyle", {
        ...
        */
        get: function () {
            ...
            if (!this.i.sb.externalObject) {
                var e = new IgrStyle();
                e._implementation = this.i.sb;
                this.i.sb.externalObject = e;
            }
            return this.i.sb.externalObject;
        },
        set: function (v) {
            v == null ? this.i.sb = null : this.i.sb = v.i;
        },
        enumerable: false,
        configurable: true
    });
...
//# sourceMappingURL=igr-scatter-polyline-series.js.map
