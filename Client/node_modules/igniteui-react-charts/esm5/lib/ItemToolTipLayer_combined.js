...
var ItemToolTipLayer = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    ItemToolTipLayer.prototype.get_c5 = function () {
        return true;
    };
    ItemToolTipLayer.prototype.bu = function () {
        return new ItemToolTipLayerView(this);
    };
    ItemToolTipLayer.prototype.lh = function (a) {
        _super.prototype.lh.call(this, a);
        this.qm = a;
    };
    ItemToolTipLayer.prototype.get_de = function () {
        return true;
    };
    ItemToolTipLayer.prototype.lm = function (a, b, c, d) {
    ...
    ItemToolTipLayer.prototype.p3 = function (a, b) {
        if (this.qn == null || this.qn == a) {
            if (!this.as.c) {
                this.l0(b);
            }
        }
    };
    ItemToolTipLayer.prototype.pq = function (a) {
        ...
        if (this.qt != null) {
            if (a.dn) {
                var b = a.i9();
                if (!Base.equalsStatic(this.qt, b)) {
                    return false;
                }
            }
            else {
                if (!Base.equalsStatic(this.qt, a.name)) {
                    return false;
                }
            }
        }
    ...
    ItemToolTipLayer.prototype.p5 = function (a, b) {
        var e_1, _a;
        var _this = this;
    ...
    ItemToolTipLayer.prototype.qx = function (a) {
        ...
        if (b._inner[b.count - 1].e.y + b._inner[b.count - 1].a > this.bx.bu.height) {
            b._inner[b.count - 1].e = { $type: Point_$type, x: b._inner[b.count - 1].e.x, y: b._inner[b.count - 1].e.y - ((b._inner[b.count - 1].e.y + b._inner[b.count - 1].a) - this.bx.bu.height) };
        }
    ...
    ItemToolTipLayer.prototype.qo = function (a) {
        if (a.count <= 1) {
            return false;
        }
        var b = this.bx.bu;
    ...
    ItemToolTipLayer.prototype.qy = function (a, b, c, d, e) {
        var f = this.py(a);
        if (!f.c) {
            return;
        }
        ...
        if (!this.qm.b6(a, l, i, n)) {
            return;
        }
        var o = this.qm.cg(l, i, n);
        b.i.add1(l);
        b.j.add1(n);
        b.l.add1(i);
        var p = g.x;
    ...
    ItemToolTipLayer.prototype.qr = function (a) {
        return a.toolTip;
    };
    ItemToolTipLayer.prototype.kx = function () {
        this.qj = { $type: Point_$type, x: NaN, y: NaN };
        this.qm.ce();
    };
    ItemToolTipLayer.prototype.p8 = function (a, b) {
        ...
        for (var i = 0; i < d; i++) {
            ...
            this.qm.cf(o, p, q, r, s);
        }
    };
    ItemToolTipLayer.prototype.eg = function () {
        return true;
    };
    ItemToolTipLayer.$t = markType(ItemToolTipLayer, 'ItemToolTipLayer', AnnotationLayer.$);
    ItemToolTipLayer.$$p = markDep(DependencyProperty, PropertyMetadata, ItemToolTipLayer, 'raisePropertyChanged', ['SkipUnknownValues:qp:qz', [0, true], 'TargetSeriesName:qt:q0', [2, null], 'TargetSeries:qn:q1', [Series.$, null], 'UseInterpolation:qq:q2', [0, false]]);
...
var ItemToolTipLayerView = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    ItemToolTipLayerView.prototype.aj = function () {
        ...
        for (var a = 0; a < this.b5.a.count; a++) {
            this.b5.a._inner[a].bo();
        }
        for (var b = 0; b < this.b5.b.count; b++) {
            this.b5.b._inner[b].bo();
        }
        this.b5.clear();
    };
    ...
    ItemToolTipLayerView.prototype.b6 = function (a, b, c, d) {
        var e = b;
        if (a.hr == "default") {
            a.hr = a.bx.getDefaultTooltipTemplate();
        }
        var template_ = a.hr;
        var context_ = d;
        if (a.toolTip == null) {
    ...
    ItemToolTipLayerView.prototype.a6 = function (a, b) {
        ...
        for (var g = 0; g < this.b7.count; g++) {
            this.b7._inner[g].bu(this.b7._inner[g].n + c, this.b7._inner[g].o + d);
        }
    };
    ItemToolTipLayerView.prototype.al = function (a) {
        ...
        try {
            for (var _b = __values(fromEnum(this.b5.a)), _c = _b.next(); !_c.done; _c = _b.next()) {
                ...
                this.e.a6.addPointerTooltipData(a, c, d, e, f);
            }
        }
        catch (e_2_1) {
            e_2 = { error: e_2_1 };
