...
var Stacked100BarBucketCalculator = /** @class */ /*@__PURE__*/ (function (_super) {
    ...
    Stacked100BarBucketCalculator.prototype.getBucket1 = function (a, b, c, d, e, f) {
        ...
        for (var u = s; u <= t; ++u) {
            ...
            k = Math.abs(g.st[u]) + g.ss[u];
            if (j < l) {
                p = Math.min(p, (i.logicalSeriesLink.aq._inner[u] + j) / k * 100);
                o = Math.max(o, i.logicalSeriesLink.aq._inner[u] / k * 100);
            }
            else {
                p = Math.min(p, i.logicalSeriesLink.ap._inner[u] / k * 100);
                o = Math.max(o, (i.logicalSeriesLink.ap._inner[u] + j) / k * 100);
            }
            if (!isNaN_(m)) {
                if (!isNaN_(p)) {
                    m = Math.min(m, p);
        ...
        var v = new ScalerParams(0, d, e, g.xAxis.cc, q);
        h = [f.f._inner[b - this.e][0], g.xAxis.d8(n, v), g.xAxis.d8(m, v)];
        return h;
    };
