...
export let FilterOperandDescriptionMetadata = /*@__PURE__*/ (() => {
    class FilterOperandDescriptionMetadata extends Base {
        static b(a) {
            ...
            if (a.g(FilterOperandDescriptionMetadata.a)) {
                return;
            }
            a.s(FilterOperandDescriptionMetadata.a);
        ...
        static d(a) {
            ...
            a.u("FilterOperand", () => new FilterOperandDescription());
            a.t("FilterOperand", FilterOperandDescriptionMetadata.a);
        }
    }
    FilterOperandDescriptionMetadata.$t = /*@__PURE__*/ markType(FilterOperandDescriptionMetadata, 'FilterOperandDescriptionMetadata');
...
export let GridCustomFilterRequestedEventArgsDescriptionMetadata = /*@__PURE__*/ (() => {
    class GridCustomFilterRequestedEventArgsDescriptionMetadata extends Base {
        static b(a) {
            ...
            if (a.g(GridCustomFilterRequestedEventArgsDescriptionMetadata.a)) {
                return;
            }
            a.s(GridCustomFilterRequestedEventArgsDescriptionMetadata.a);
        ...
        static d(a) {
            ...
            a.u("GridCustomFilterRequestedEventArgs", () => new GridCustomFilterRequestedEventArgsDescription());
            a.t("GridCustomFilterRequestedEventArgs", GridCustomFilterRequestedEventArgsDescriptionMetadata.a);
        }
    }
    GridCustomFilterRequestedEventArgsDescriptionMetadata.$t = /*@__PURE__*/ markType(GridCustomFilterRequestedEventArgsDescriptionMetadata, 'GridCustomFilterRequestedEventArgsDescriptionMetadata');
    GridCustomFilterRequestedEventArgsDescriptionMetadata.a = null;
    return GridCustomFilterRequestedEventArgsDescriptionMetadata;
})();
//# sourceMappingURL=FilterOperandDescriptionMetadata_combined.js.map
